...
typedef enum {
    ...
    WHY2025_KEY_F5        = 6,
    WHY2025_KEY_F6        = 7,
    WHY2025_KEY_BACKSPACE = 8,
    WHY2025_KEY_NUM_0     = 9,

    WHY2025_KEY_NUM_MINUS = 10,
    WHY2025_KEY_GRAVE     = 11,
    WHY2025_KEY_NUM_1     = 12,
    WHY2025_KEY_NUM_2     = 13,
    WHY2025_KEY_NUM_3     = 14,
    WHY2025_KEY_NUM_4     = 15,
    WHY2025_KEY_NUM_5     = 16,
    WHY2025_KEY_NUM_6     = 17,
    WHY2025_KEY_NUM_7     = 18,
    WHY2025_KEY_NUM_8     = 19,

    WHY2025_KEY_NUM_9 = 20,
    WHY2025_KEY_TAB   = 21,
    WHY2025_KEY_Q     = 22,
    WHY2025_KEY_W     = 23,
    WHY2025_KEY_E     = 24,
    ...
    WHY2025_KEY_N          = 47,
    WHY2025_KEY_M          = 48,
    WHY2025_KEY_COMMA      = 49,
    WHY2025_KEY_DOT        = 50,

    WHY2025_KEY_LEFT        = 51,
    WHY2025_KEY_DOWN        = 52,
    WHY2025_KEY_RIGHT       = 53,
    WHY2025_KEY_SLASH       = 54,
    WHY2025_KEY_UP          = 55,
    WHY2025_KEY_RIGHT_SHIFT = 56,
    WHY2025_KEY_SEMICOLON   = 57,
    WHY2025_KEY_APOSTROPHE  = 58,
    WHY2025_KEY_ENTER       = 59,
    WHY2025_KEY_EQUAL       = 60,
    ...
    for (int i = 0; i < 10; i++) {
        ...
        switch (key) {
            ...
            case WHY2025_KEY_F5:
                ...
                break;
            case WHY2025_KEY_F6:
                send_scancode_event(BSP_INPUT_SCANCODE_F6, pressed);
                send_navigation_event(BSP_INPUT_NAVIGATION_KEY_F6, pressed, active_modifiers);
                break;
            case WHY2025_KEY_Q:
